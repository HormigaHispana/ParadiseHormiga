...
/mob/living/carbon/ant/humanoid
	name = "ant"
	icon_state = "antw_s"
...
/* TEMPORAL POR DUPLICATE DEFINITION
...
/mob/living/carbon/ant/humanoid/Initialize(mapload)
	if(name == "alien")
...
*/
/mob/living/carbon/ant/humanoid/Process_Spacemove(check_drift = 0)
	if(..())
		return TRUE
	return FALSE

/mob/living/carbon/ant/humanoid/ex_act(severity)
	..()
...
/mob/living/carbon/ant/humanoid/restrained()
	if(handcuffed)
		return TRUE
	return FALSE

/mob/living/carbon/ant/humanoid/movement_delay() //Aliens have a varied movespeed
	. = ..()
	. += alien_movement_delay

/mob/living/carbon/ant/humanoid/resist_restraints(attempt_breaking)
	playsound(src, 'sound/voice/hiss5.ogg', 40, TRUE, 1)  //Alien roars when starting to break free
	attempt_breaking = TRUE
	return ..()

/mob/living/carbon/ant/humanoid/get_standard_pixel_y_offset()
	if(leaping)
		return -32
...
/mob/living/carbon/ant/humanoid/get_standard_pixel_x_offset(lying = 0)
	if(leaping)
		return -32
...
/mob/living/carbon/ant/humanoid/get_permeability_protection()
	return 0.8
