/mob/living/carbon/ant/humanoid/scout
	name = "scout Ant"
	caste = "s"
	maxHealth = 150
	health = 150
...
/mob/living/carbon/ant/humanoid/scout/Initialize(mapload)
	. = ..()
	name = "scout ([rand(1, 1000)])"
	real_name = name

/mob/living/carbon/ant/humanoid/scout/get_caste_organs()
	. = ..()
	. += /obj/item/organ/internal/alien/plasmavessel/hunter

/mob/living/carbon/ant/humanoid/scout/handle_environment()
...
/*REMOVER
/mob/living/carbon/ant/humanoid/scout/proc/toggle_leap(message = TRUE)
...
/*REMOVER
/mob/living/carbon/ant/humanoid/scout/proc/leap_at(atom/A)
