/mob/living/carbon/ant/humanoid/soldier
	name = "soldier Ant"
	caste = "f"
	maxHealth = 150
	health = 150
...
/mob/living/carbon/ant/humanoid/soldier/Initialize(mapload)
	. = ..()
	name = "soldier ([rand(1, 1000)])"
	real_name = name

/mob/living/carbon/ant/humanoid/soldier/get_caste_organs()
	. = ..()
	. += /obj/item/organ/internal/alien/plasmavessel/hunter

/mob/living/carbon/ant/humanoid/soldier/handle_environment()
...
/*REMOVER
/mob/living/carbon/ant/humanoid/soldier/proc/toggle_leap(message = TRUE)
...
/*REMOVER
/mob/living/carbon/ant/humanoid/soldier/proc/leap_at(atom/A)
