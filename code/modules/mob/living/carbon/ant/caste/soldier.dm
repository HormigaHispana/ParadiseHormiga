/mob/living/carbon/alien/humanoid/ant/soldier
	name = "soldier Ant"
	caste = "f"
	maxHealth = 150
	health = 150
...
/mob/living/carbon/alien/humanoid/ant/soldier/Initialize(mapload)
	. = ..()
	name = "soldier ([rand(1, 1000)])"
	real_name = name

/mob/living/carbon/alien/humanoid/ant/soldier/get_caste_organs()
	. = ..()
	. += list(
		/obj/item/organ/internal/alien/plasmavessel/hunter,
		/obj/item/organ/internal/alien/neurotoxin,)

/mob/living/carbon/alien/humanoid/ant/soldier/handle_environment()
...
/mob/living/carbon/alien/humanoid/ant/soldier/proc/toggle_leap(message = TRUE)
...
/mob/living/carbon/alien/humanoid/ant/soldier/proc/leap_at(atom/A)
...
/mob/living/carbon/alien/humanoid/ant/soldier/proc/leap_end()
	leaping = FALSE
	SetImmobilized(0, TRUE)
	update_icons()

/mob/living/carbon/alien/humanoid/ant/soldier/throw_impact(atom/A)
	if(!leaping)
		return ..()
...
/mob/living/carbon/alien/humanoid/ant/soldier/update_icons()
	..()
...
/mob/living/carbon/alien/humanoid/ant/soldier/float(on)
	if(leaping)
		return
	..()
