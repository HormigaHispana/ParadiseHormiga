/obj/item/organ/internal/alien/ant
	origin_tech = "biotech=5"
	icon = 'icons/hormiga/ant_organs.dmi'
	icon_state = "xgibmid2"
	var/list/alien/ant_powers = list()
	list/human_powers = list()
	tough = TRUE
	sterile = TRUE
...
/obj/item/organ/internal/alien/ant/insert(mob/living/carbon/M, special = 0)
	..()
	if(!hijacked)
...
/obj/item/organ/internal/alien/ant/remove(mob/living/carbon/M, special = 0)
	if(!hijacked)
...
/obj/item/organ/internal/alien/ant/examine(mob/user)
	. = ..()
...
/obj/item/organ/internal/alien/ant/attackby(obj/item/hemostat/item, mob/user, params)
	if(istype(item))
		if(!hijacked)
...
/obj/item/organ/internal/alien/ant/prepare_eat()
	var/obj/S = ..()
...
/obj/item/organ/internal/alien/ant/plasmavessel
	name = "xeno plasma vessel"
	icon_state = "plasma"
	w_class = WEIGHT_CLASS_NORMAL
	origin_tech = "biotech=5;plasmatech=4"
	slot = "plasmavessel"
	alien_powers = list(/datum/spell/ant_spell/plant_weeds,)
	human_powers = list()
...
/obj/item/organ/internal/alien/ant/plasmavessel/prepare_eat()
	var/obj/S = ..()
	S.reagents.add_reagent("plasma", stored_plasma / 10)
	return S

/obj/item/organ/internal/alien/ant/plasmavessel/queen
...
/obj/item/organ/internal/alien/ant/plasmavessel/drone
	name = "large xeno plasma vessel"
	icon_state = "plasma_large"
	stored_plasma = 200

/obj/item/organ/internal/alien/ant/plasmavessel/sentinel
	stored_plasma = 100
	max_plasma = 250

/obj/item/organ/internal/alien/ant/plasmavessel/hunter
	name = "small xeno plasma vessel"
	icon_state = "plasma_tiny"
	stored_plasma = 50
	max_plasma = 100

/obj/item/organ/internal/alien/ant/plasmavessel/larva
...
/obj/item/organ/internal/alien/ant/plasmavessel/on_life()
...
/obj/item/organ/internal/alien/ant/plasmavessel/insert(mob/living/carbon/M, special = 0)
	..()
	M.update_plasma_display(M)

/obj/item/organ/internal/alien/ant/plasmavessel/remove(mob/living/carbon/M, special = 0)
	. =..()
	M.update_plasma_display(M)

/obj/item/organ/internal/alien/ant/acidgland
...
/obj/item/organ/internal/alien/ant/hivenode
	name = "xeno hive node"
	icon_state = "hivenode"
	slot = "hivenode"
...
/obj/item/organ/internal/alien/ant/hivenode/insert(mob/living/carbon/M, special = 0)
	..()
	M.faction |= "alien"
...
/obj/item/organ/internal/alien/ant/hivenode/remove(mob/living/carbon/M, special = 0)
	M.faction -= "alien"
...
/obj/item/organ/internal/alien/ant/neurotoxin
...
/obj/item/organ/internal/alien/ant/resinspinner
...
/obj/item/organ/internal/alien/ant/eggsac
	name = "xeno egg sac"
	icon_state = "eggsac"
	slot = "eggsac"
	w_class = WEIGHT_CLASS_BULKY
	origin_tech = "biotech=6"
	alien_powers = list(/datum/spell/ant_spell/plant_weeds/eggs)
	human_powers = list(/datum/spell/ant_spell/combust_facehuggers)
	cargo_profit = 1000
