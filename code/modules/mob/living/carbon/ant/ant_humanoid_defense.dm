/mob/living/carbon/ant/humanoid/attack_hulk(mob/living/carbon/human/user, does_attack_animation = FALSE)
...
/mob/living/carbon/ant/humanoid/attack_hand(mob/living/carbon/human/M)
	if(..())
		switch(M.a_intent)
			if(INTENT_HARM)
				var/damage = rand(1, 9)
...
/mob/living/carbon/ant/humanoid/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect)
